...
```bash
# Install CodeIgniter unit tests
php application/vendor/kenjis/ci-phpunit-test/install.php

# Remove generic welcome test
...
Please note that you need PHPUnit installed on your machine. Running `apt-get install phpunit` will do the work for [Linux](https://www.linux.org/)-based operating systems. 
...
This command will test following:
